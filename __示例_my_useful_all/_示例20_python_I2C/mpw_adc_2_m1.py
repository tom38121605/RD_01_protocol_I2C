...
I2C_Write_v2(I2C_Addr,0x20,0x85)
...
#--I2C_Write_v2(I2C_Addr,0x23,0x00)  #-- set reg23.0=0 for sampling x,y,z
I2C_Write_v2(I2C_Addr,0x23,0x80)  #-- set reg23.7=1, sampling and set vref to 1.245v
...
#--I2C_Write_v2(I2C_Addr,0x28,0x64)    #--increase the settling time from 20us to 40us
...
#  command=0b1100_0011
    ...
    #--command=0b1000_0010    #0x82
    #--command = 0b0100_0010    #0x42， reset + read xyz
    #--command = 0b0100_0011  # 0x43， reset + read xyzt
    command = 0b0000_0011  # Read xyzt
...
#        print("I2C Read ",''.join('{:02x} '.format(a) for a in FIFO),end='')
        if (Sample_count==1):
            ...
            #--print("Y1:",int.from_bytes(FIFO[3:6],"big",signed="True") )
            #--print("Z1:",int.from_bytes(FIFO[6:9],"#--big",signed="True") )

            #--print("X1:", (int)( FIFO[0]*256*256+FIFO[1]*256+FIFO[2]) )
            #--print("Y1:", (int)(FIFO[3] * 256 * 256 + FIFO[4] * 256 + FIFO[5]))
            #--print("Z1:", (int)(FIFO[6] * 256 * 256 + FIFO[7] * 256 + FIFO[8]))
        ...
        #         ,"Z1:",int.from_bytes(FIFO[6:9],"big",signed="True"))
            ...
            print("X1:",int.from_bytes(FIFO[0:3],"big",signed="True"),file=f )
            #--print("X1:", (int)( FIFO[0]*256*256+FIFO[1]*256+FIFO[2]),file=f )
            ...
            #     ,"Y1:",int.from_bytes(FIFO[3:6],"big",signed="True")\
            #     ,"Z1:",int.from_bytes(FIFO[6:9],"big",signed="True")\
            #     ,"T1:",int.from_bytes(FIFO[9:12],"big",signed="True"),file=f)
